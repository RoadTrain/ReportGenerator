...
namespace Palmmedia.ReportGenerator.Core.Reporting.Builders
{
    ...
    /// </summary>
    public class HtmlSummaryDarkReportBuilder : ReportBuilderBase
    {
        /// <summary>
        ...
        /// The report format.
        /// </value>
        public override string ReportType => "HtmlSummaryDark";
        ...
        {
            using (var renderer = new HtmlRenderer(new Dictionary<string, string>(), true, HtmlMode.InlineCssAndJavaScript, "custom.css", "custom_dark.css"))
            {
