...
namespace Palmmedia.ReportGenerator.Core.Reporting.Builders
{
    ...
    /// </summary>
    public class HtmlInlineCssAndJavaScriptReportDarkBuilder : ReportBuilderBase
    {
        /// <summary>
        ...
        /// The report format.
        /// </value>
        public override string ReportType => "HtmlInlineDark";
        ...
        {
            using (var renderer = new HtmlRenderer(this.fileNameByClass, false, HtmlMode.InlineCssAndJavaScript, "custom.css", "custom_dark.css"))
            {
