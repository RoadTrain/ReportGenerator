...
- task: Palmmedia.reportgenerator.reportgenerator-build-release-task.reportgenerator@4
      ...
      inputs:
        ...
        reporttypes: 'HtmlInline_AzurePipelines;Cobertura' # The output formats and scope (separated by semicolon) Values: Badges, Clover, Cobertura, CsvSummary, Html, HtmlDark, HtmlChart, HtmlInline, HtmlInlineDark, HtmlInline_AzurePipelines, HtmlInline_AzurePipelines_Dark, HtmlSummary, HtmlSummaryDark, JsonSummary, Latex, LatexSummary, lcov, MarkdownSummary, MHtml, PngChart, SonarQube, TeamCitySummary, TextSummary, Xml, XmlSummary
