...
Explanations:
   ...
   Report types:       The output formats and scope (separated by semicolon).
                       ...
                       Html, HtmlDark, HtmlChart, HtmlInline, HtmlInlineDark, 
                       HtmlInline_AzurePipelines, HtmlInline_AzurePipelines_Dark, HtmlSummary, HtmlSummaryDark,
